...
class EncoderRNN(nn.Module):
    ...
    def __init__(self,
        ...
        Uses a different mask for each timestep, which has been shown to
...
class Attention(nn.Module):
    ...
    and a linear transform of the states concatenated together.
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        if self.method == 'general':
            ...
            enc_out = encoder_outputs.data.new(encoder_outputs.size()).fill_(1)
            hidden *= to_var(enc_out)
